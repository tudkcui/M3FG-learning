...
import args_parser
from utils import eval_curr_major_reward, eval_curr_minor_reward
...
def plot():
    ...
    plt.savefig(f'./figures/J_J0_num_agents.pdf', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.savefig(f'./figures/J_J0_num_agents.png', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.show()
