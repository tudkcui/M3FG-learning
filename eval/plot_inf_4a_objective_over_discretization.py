...
def plot():
    ...
    plt.savefig(f'./figures/inf_J_J0_discretization.pdf', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.savefig(f'./figures/inf_J_J0_discretization.png', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.show()
