...
import args_parser
from utils import get_softmax_action_probs_from_Qs, eval_discounted_curr_major_reward, eval_discounted_curr_minor_reward
...
def plot():
    ...
    plt.savefig(f'./figures/inf_J_J0_num_agents_maxent.pdf', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.savefig(f'./figures/inf_J_J0_num_agents_maxent.png', bbox_inches='tight', transparent=True, pad_inches=0.1)
    plt.show()
